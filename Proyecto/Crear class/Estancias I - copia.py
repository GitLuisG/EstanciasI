...
class ServicioGoogle:
        ...
        def ConsultarEventos(self, Servicio):
                result = Servicio.calendarList().list().execute()
                calendar_id = result['items'][0]['id']
                Pagina = None
        ...
        def CrearMensaje(self, Hacia, Servicio, ServicioG, Mensaje):
                print('Crear Mensaje')
                result = Servicio.calendarList().list().execute()
